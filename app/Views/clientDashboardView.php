...
<body>
  ...
  <!-- cette partie est la top navigation -->
    ...
    <h3>Que chercher vous ?</h3>
        <form action="/services/recherche" method="post" class="flex items-center justify-center" >
            <div class="flex flex-col">
                <label for="categories">Choisir la catégorie :</label>
                <select name="categories" id="" class="border-2 p-2  border-black">
            ...
            <div class="flex flex-col">
                <label for="wilayas">Choisir la Wilaya :</label>
                <select name="wilayas" id="" class="border-2 p-2  border-black">
                    <option value="Béjaia">Béjaia</option>
                </select>
            </div>  

            <div class="flex flex-col">
                <label for="dairas">Choisir la Daira :</label>
                <select name="dairas" id="" class="border-2 p-2  border-black">
            ...
            <div class="flex flex-col">
                <label for="communes">Choisir la Commune :</label>
                <select name="communes" id="" class="border-2 p-2  border-black">
                    <option value="El Flaye">El Flaye</option>
                </select>
            </div>  

            <div class="flex flex-col">
                <label for="tarif">Choisir le Tarif Maximum :</label>
                <input name="tarif" type="number" placeholder="Le tarif maximum en DA" class="border-2 p-2  border-black">
            </div> 
